 //I wanted to make a clock where I need a code that represents a clock where for example the time is 4:25. there are 4 large lavender circles to represent the hour, 2 smaller orange squares to represent the tens place of the minute, 5 smaller yellow to represent the ones place of the minutes, then blue triangles to represent the seconds. I want each unit to stay within a quarter of the canvas, so the hour is in the first quarter, the tenths place is the second quarter, the ones place is the third quarter, and seconds is in the fourth quarter. This is shown going left to right.
